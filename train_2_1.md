### [1. Основные понятия и определения.]([README.mdmodel#1-основные-понятия-и-определения](https://github.com/YmkaBoom/model#1-основные-понятия-и-определения))
...
### [2. Функции, цели и задачи стандартизации]([README.md#2Функции_цели_и_задачи_стандартизации](https://github.com/YmkaBoom/model#2-функции-цели-структура-и-задачи-стандартизации))
